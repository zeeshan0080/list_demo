...
class GroupedListViewView extends StatefulWidget {
  const GroupedListViewView({super.key});

  @override
  State<GroupedListViewView> createState() => _GroupedListViewViewState();
}

class _GroupedListViewViewState extends State<GroupedListViewView> {
        ...
        children: [
          Expanded(
            child: GroupedListView<MessageModel, DateTime>(
              ...
              groupSeparatorBuilder: (DateTime details) {
                return Text(
